...
const Login = () => {
  ...
  return (
    <div className='flex justify-center'>
      ...
      <form className='absolute top-20  w-screen md:w-1/2 lg:w-1/4 h-auto  bg-zinc-900 bg-opacity-85 flex flex-col p-10 md:p-20 text-center' onSubmit={(e)=> e.preventDefault()}>
